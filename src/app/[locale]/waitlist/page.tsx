...
export default function WaitlistPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.benabraham.ai/waitlist", {
        method: "POST",
    ...
    <>
      ...
      <section className="relative overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 sm:py-32 relative z-10 w-full text-center">
          ...
          {/* Subheadline */}
          <p className="mt-6 text-lg sm:text-xl md:text-2xl text-cream-secondary max-w-2xl mx-auto leading-relaxed">
            {t("hero_subtitle")}
          </p>
          ...
          <div className="mt-6 max-w-md mx-auto">
            {status === "success" ? (
              ...
              <div className="glass-card rounded-2xl p-8 text-center animate-fade-in">
                ...
                <p className="text-xl font-bold text-cream">{t("duplicate_message")}</p>
              </div>
            ) : (
      ...
      <section className="relative py-20 sm:py-28 bg-espresso overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <div className="glass-card rounded-3xl p-8 sm:p-12 lg:p-16 text-center border-ficha-gold/20">
            ...
            <p className="mt-6 text-lg text-cream-secondary max-w-xl mx-auto leading-relaxed">
      ...
      {/* Footer Tagline */}
      <section className="py-12 bg-dark-deep text-center">
        <p className="text-xl sm:text-2xl font-bold text-cream-secondary italic">
